About chessanalysispipeline-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/chessanalysispipeline-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/chessanalysispipeline-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add chessanalysispipeline
# for installing globally
pixi global install chessanalysispipeline
```
...
It is possible to list all of the versions of `chessanalysispipeline` available on your platform:
...
```
pixi search chessanalysispipeline --channel conda-forge
```
